...
const Navbar: React.FC<NavbarProps> = ({ lang, setLang, theme, setTheme, scrolled }) => {
    ...
    return (
        <nav className={`fixed top-0 left-0 w-full z-[99999] px-6 md:px-12 py-3 transition-all duration-500 flex justify-between items-center bg-black/90 backdrop-blur-xl border-b border-white/10 shadow-2xl shadow-black/50`}>

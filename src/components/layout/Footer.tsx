                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                    <div className="space-y-8">
                        ...
                        <div className="flex gap-6">
                            <a href="https://github.com/Su03l" target="_blank" rel="noopener noreferrer" className="text-xl opacity-40 hover:opacity-100 hover:text-blue-500 transition-all"><i className="fab fa-github"></i></a>
                            <a href="https://linkedin.com/in/suliaman-yousef-36265a320" target="_blank" rel="noopener noreferrer" className="text-xl opacity-40 hover:opacity-100 hover:text-blue-500 transition-all"><i className="fab fa-linkedin"></i></a>
                            <a href="https://twitter.com/Su05l" target="_blank" rel="noopener noreferrer" className="text-xl opacity-40 hover:opacity-100 hover:text-blue-500 transition-all"><i className="fab fa-twitter"></i></a>
                        </div>
                    </div>

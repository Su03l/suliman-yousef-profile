...
export const LARAVEL_COLLECTION_ITEMS = [
    ...
    },
    {
        ...
        desc: {
            en: "An advanced Backend system simulating complex university registration processes. It focuses on maintaining data integrity under high concurrency and enforcing strict academic rules, similar to global systems like Banner.\n\nSmart Registration Engine:\n• The system applies five strict validation layers: Time Conflict Detection (minute-level precision), Prerequisites Logic, Anti-Duplication, Capacity Management, and Concurrency Control using Pessimistic Locking to prevent overbooking.\n\nAutomated Waitlist System:\n• Smart handling of full sections: Students are added to a FIFO waitlist. When a student withdraws, the system automatically promotes and registers the first student in the queue and updates capacity immediately.\n\nAdvanced Data Structure:\n• Separation of Concerns: Separate entities for Courses and Sections.\n• Self-Referencing Relationships: Academic Advisor-Student relationships within the Users table.\n• Data Integrity: Using Soft Deletes to maintain academic history and API Resources for clean JSON responses.\n\nSecurity & Access Control:\n• Token-based authentication via Laravel Sanctum and strict Role-Based Access Control (RBAC) via Middleware.",
